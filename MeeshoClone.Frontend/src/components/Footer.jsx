    ...
    sections.push({
      ...
      content: (
        <div className="space-y-4">
          <h3 className="text-2xl font-bold text-pink-400 tracking-tight">{config.footer?.companyName || 'Meesho Clone'}</h3>
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="border-t border-white/10 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm text-center md:text-left">{config.footer?.copyrightText || '© 2024 Meesho Clone. All rights reserved.'}</p>
